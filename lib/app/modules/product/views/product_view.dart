...
class ProductView extends GetView<ProductController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProductController>(
      ...
      builder: (controller) {
        return CommonScreen(
            title: Constants.selectUser == Constants.consumer ? "Fruit" : controller.getCategoryData?.name ?? "",
            actions: [
            ...
            body: Obx(() => controller.getCategory.value != null ? controller.getProductList.isEmpty
                    ...
                    children: [
                      ...
                      return GestureDetector(
                        onTap: () {
                          ...
                          Get.toNamed(Routes.PRODUCT_DETAIL, arguments: {"details" : data, "category_details" : controller.getCategoryData})?.then((value) {
                            if(value != null && value == "delete"){
                              controller.getProductList.removeAt(controller.selectIndex);
                            } else {
                                ...
                                child: Theme(
                                  ...
                                  child: PopupMenuButton<dynamic>(
                                    ...
                                    onSelected: (dynamic value) {
                                      controller.addArchive(productId: data.productId ?? 0, index: index);
                                    },
                      ...
                      Obx(() => controller.isPaginationLoading.value ? Padding(
