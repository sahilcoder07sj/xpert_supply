  ...
  Widget build(BuildContext context) {
    return CommonScreen(
      ...
      body: Padding(
        ...
        child: Obx(() => controller.errorMessage.isEmpty ? Column(
          children: [
            10.verticalSpace,
            Expanded(
                  ...
                  return GestureDetector(
                    ...
                    child: Column(
                      children: [
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Obx(() => CommonWidget.circularIconWidget(
                                      radius: 15.0,
                                      icon: data.isCheck?.value == true ? AppIcons.iconsUpArrow : AppIcons.iconsDownArrow,
                                    )),
                                    5.horizontalSpace,
                                  ],
                                ),
                              ),
                              Obx(() => data.isCheck?.value == true ? Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  15.verticalSpace,
                                  Padding(
                                  ...
                                  if(Constants.vendor == Constants.selectUser && data.status == "pending")...[
                                    10.verticalSpace,
                                    buildDivider(),
                                    20.verticalSpace,
                                    Padding(
                                        ...
                                        children: [
                                          Expanded(
                                            child: CommonButton(
                                              ...
                                              onTap: () => controller.manageQuote(isSend: false, quoteId: data.quoteId, index: index),
                                            ),
                                          ),
                                          15.horizontalSpace,
                                          Expanded(
                                            child: CommonButton(
                                              ...
                                              bgColor: AppColors.white,
                                              fontColor: AppColors.primary,
                                              onTap: () => controller.sendOfferDialogue(quoteId: data.quoteId ?? 0),
                                            ),
                                          ),
                                        ],
                                      ),
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: AppText(
                                          ...
                                          color: data.status == "canceled" ? AppColors.red : Colors.green,
                                        ),
                                      ),
                                    ],
                                  )
                        ...
                        Obx(() => controller.isPaginationLoading.value && controller.quoteList.length-1 == index ? CircularProgressIndicator(strokeWidth: 1.0, color: AppColors.primary) : SizedBox())
                      ],
                    ),
                  );
                },),
